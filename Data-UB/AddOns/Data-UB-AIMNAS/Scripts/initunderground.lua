...
local sectorList = {
	...
	{ location = "I13-1", loadscreen = "LS_MINE", },
	{ location = "J13-1", loadscreen = "LS_MINE", },
    { location = "J14-1", loadscreen = "LS_MINE", },
	{ location = "E10-1", loadscreen = "LS_TUNNELS", },
	{ location = "D10-1", loadscreen = "LS_TUNNELS", },
	{ location = "D9-1", loadscreen = "LS_UPSTAIRS", },
	{ location = "D9-2", loadscreen = "LS_COMPLEXBSMNT", },
	{ location = "D9-3", loadscreen = "LS_BASEMENT_GENERIC", },
...
local function PopulateSectors(difficultyLevel, gameStyle, maxEnemies)
	...
	if difficultyLevel == 1 then
		s["D9-1"].numTroops = 14  + math.random(0, 6)
		s["D9-1"].numElites = 0
	elseif difficultyLevel == 2 then
		s["D9-1"].numTroops = 21  + math.random(0, 4)
		s["D9-1"].numElites = 4  + math.random(0, 3)
	elseif difficultyLevel == 3 then
		s["D9-1"].numTroops = 30  + math.random(0, 4)
		s["D9-1"].numElites = 20  + math.random(0, 4)
	elseif difficultyLevel == 4 then
		s["D9-1"].numTroops = 24 + math.random(0, 6)
		s["D9-1"].numElites = 30 + math.random(0, 2)
	end
    LimitUndergroundEnemies(s["D9-1"], maxEnemies)

	if difficultyLevel == 1 then
		s["D9-2"].numTroops = 12 + math.random(0, 3)
		s["D9-2"].numElites = 0
	elseif difficultyLevel == 2 then
		s["D9-2"].numTroops = 20 + math.random(0, 2)
		s["D9-2"].numElites = 5 + math.random(0, 2)
	elseif difficultyLevel == 3 then
		s["D9-2"].numTroops = 22 + math.random(0, 3)
		s["D9-2"].numElites = 13 + math.random(0, 2)
	elseif difficultyLevel == 4 then
		s["D9-2"].numTroops = 22 + math.random(0, 6)
		s["D9-2"].numElites = 20 + math.random(0, 2)
	end
    LimitUndergroundEnemies(s["D9-2"], maxEnemies)
    ...
    LimitUndergroundEnemies(s["D9-3"], maxEnemies)
